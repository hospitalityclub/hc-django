    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('contact_method', models.CharField(choices=[('phone', 'phone'), ('email', 'email'), ('whatsapp', 'WhatsApp'), ('facebook', 'Facebook'), ('telegram', 'Telegram'), ('skype', 'Skype'), ('homepage', 'home page')], default='phone', max_length=15, verbose_name='contact method')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updated_at', models.DateTimeField(auto_now=True, verbose_name='Updated at')),
                ('created_at', models.DateTimeField(auto_now_add=True, verbose_name='Created at')),
                ('member', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='translated_member', to='hccore.Member', verbose_name='Member')),
            ],
            options={
                'verbose_name': 'translated member field',
                'verbose_name_plural': 'translated member fields',
            },
        ),
        migrations.CreateModel(
            name='TransMemberTranslation',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('language_code', models.CharField(db_index=True, max_length=15)),
                ('master', hvad.fields.MasterKey(editable=False, on_delete=django.db.models.deletion.CASCADE, related_name='translations', to='hccore.TransMember')),
                ('about_myself', models.TextField(blank=True, max_length=4095, null=True, verbose_name='about yourself')),
                ('feedback', models.TextField(blank=True, max_length=4095, null=True, verbose_name='feedback to HC')),
                ('internal_notes', models.TextField(blank=True, help_text='for HC volunteer eyes only', null=True, verbose_name='internal notes')),
                ('occupation', models.CharField(blank=True, max_length=255, null=True, verbose_name='occupation')),
            ...
            options={
                'db_table': 'hccore_transmember_translation',
                'db_tablespace': '',
                'abstract': False,
                'managed': True,
                'default_permissions': (),
        ...
        migrations.AlterField(
            model_name='transmember',
            name='member',
            field=models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='translated_member', to='hccore.Member', verbose_name='member'),
        ),
        migrations.DeleteModel(
            name='AddressTranslation',
        ),
        migrations.CreateModel(
            ...
            options={
                'verbose_name': 'translated address field',
                'verbose_name_plural': 'translated address fields',
            },
        ),
        migrations.CreateModel(
            name='TransAddressTranslation',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('street', models.CharField(max_length=255, verbose_name='street address')),
                ('best_times', models.CharField(max_length=255, verbose_name='best times to visit')),
            ...
            options={
                'db_table': 'hccore_transaddress_translation',
                'db_tablespace': '',
                'abstract': False,
                'managed': True,
                'default_permissions': (),
        ...
        migrations.AddField(
            model_name='transaddresstranslation',
            name='master',
            field=hvad.fields.MasterKey(editable=False, on_delete=django.db.models.deletion.CASCADE, related_name='translations', to='hccore.TransAddress'),
        ),
        migrations.AddField(
            model_name='transaddress',
            name='_hvad_query',
            field=hvad.fields.SingleTranslationObject('hccore.TransAddress', 'hccore.TransAddressTranslation'),
        ),
        migrations.AlterUniqueTogether(
            name='transaddresstranslation',
            unique_together=set(),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updated_at', models.DateTimeField(auto_now=True, verbose_name='Updated at')),
                ('created_at', models.DateTimeField(auto_now_add=True, verbose_name='Created at')),
                ('interest', models.CharField(max_length=31, verbose_name='interest')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('interest', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='member_interests', to='hccore.Interest', verbose_name='hointerest')),
                ('member', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='member_interests', to='hccore.Member', verbose_name='member')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            options={
                'verbose_name': 'member travel message',
                'verbose_name_plural': 'member travel messages',
            },
        ),
        migrations.AlterUniqueTogether(
            name='membertraveltranslation',
        ...
        migrations.AddField(
            model_name='address',
            name='street',
            field=models.CharField(default='middle of nowhere', max_length=255, verbose_name='street address'),
            preserve_default=False,
        ),
        migrations.AddField(
            model_name='transaddress',
            name='address',
            field=models.OneToOneField(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='translated_address', to='hccore.Address', verbose_name='address'),
        ),
        migrations.AddField(
            model_name='transmember',
            name='_hvad_query',
            field=hvad.fields.SingleTranslationObject('hccore.TransMember', 'hccore.TransMemberTranslation'),
        ),
        migrations.AlterField(
            model_name='language',
            name='iso639_1',
            field=models.CharField(max_length=7, verbose_name='ISO 639-1 code'),
        ),
        migrations.AlterField(
            model_name='membertravel',
            name='member',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='member_travels', to='hccore.Member', verbose_name='member'),
        ),
        migrations.DeleteModel(
            name='MemberTravelTranslation',
        ),
        ...
        migrations.AddField(
            model_name='membertravelmessages',
            name='member_travel',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='member_travel_messages', to='hccore.MemberTravel', verbose_name='member travel'),
        ),
        migrations.AddField(
            model_name='membertravelmessages',
            name='sender',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='member_travel_messages', to='hccore.Member', verbose_name='sender'),
        ),
        migrations.CreateModel(
            name='MemberTravelMessagesTranslation',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('message', models.TextField(blank=True, max_length=4095, null=True, verbose_name='message')),
                ('language_code', models.CharField(db_index=True, max_length=15)),
                ('master', hvad.fields.MasterKey(editable=False, on_delete=django.db.models.deletion.CASCADE, related_name='translations', to='hccore.MemberTravelMessages')),
            ],
            options={
                'db_table': 'hccore_membertravelmessages_translation',
                'db_tablespace': '',
                'abstract': False,
                'managed': True,
                'default_permissions': (),
